...
<div class="page-header-actions"><a onclick="exportReviewsInCSV()" href="javascript:void(0);" role="button" class="btn btn-danger btn-block btn-round"><i class="icon wb-download" aria-hidden="true"></i>Download</a> </div>
...
<?php
  ...
  if( !empty( $reviews ) ){
    ...
    $starRating = array(
      ...
      0 => '<i class="icon wb-star" data-alt="1" title="bad"></i><i class="icon wb-star" data-alt="2" title="poor"></i><i class="icon wb-star" data-alt="3" title="regular"></i><i class="icon wb-star" data-alt="4" title="good"></i><i class="icon wb-star" data-alt="5" title="gorgeous"></i>',

      1 => '<i class="icon wb-star orange-600" data-alt="1" title="bad"></i><i class="icon wb-star" data-alt="2" title="poor"></i><i class="icon wb-star" data-alt="3" title="regular"></i><i class="icon wb-star" data-alt="4" title="good"></i><i class="icon wb-star" data-alt="5" title="gorgeous"></i>',

      2 => '<i class="icon wb-star orange-600" data-alt="1" title="bad"></i><i class="icon wb-star orange-600" data-alt="2" title="poor"></i><i class="icon wb-star" data-alt="3" title="regular"></i><i class="icon wb-star" data-alt="4" title="good"></i><i class="icon wb-star" data-alt="5" title="gorgeous"></i>',

      3 => '<i class="icon wb-star orange-600" data-alt="1" title="bad"></i><i class="icon wb-star orange-600" data-alt="2" title="poor"></i><i class="icon wb-star orange-600" data-alt="3" title="regular"></i><i class="icon wb-star" data-alt="4" title="good"></i><i class="icon wb-star" data-alt="5" title="gorgeous"></i>',

      4 => '<i class="icon wb-star orange-600" data-alt="1" title="bad"></i><i class="icon wb-star orange-600" data-alt="2" title="poor"></i><i class="icon wb-star orange-600" data-alt="3" title="regular"></i><i class="icon wb-star orange-600" data-alt="4" title="good"></i><i class="icon wb-star" data-alt="5" title="gorgeous"></i>',

      5 => '<i class="icon wb-star orange-600" data-alt="1" title="bad"></i><i class="icon wb-star orange-600" data-alt="2" title="poor"></i><i class="icon wb-star orange-600" data-alt="3" title="regular"></i><i class="icon wb-star orange-600" data-alt="4" title="good"></i><i class="icon wb-star orange-600" data-alt="5" title="gorgeous"></i>',

    );

    $pubStat = array(

      "Yes" => '<span class="label label-table label-success">PUBLISHED</span>',

      "No" => '<span class="label label-table label-dark">ARCHIVED</span>',
    ...
    foreach( $reviews as $review ){
      ...
      $pubStatus = $pubStat[$review['publish_status']];

      $pubAction = "";

      if( $review['publish_status'] == "No"){

        $pubAction = '<a class="btn btn-warning btn-round" role="button" onclick="publishThis('.$review['review_id'].')" href="javascript:void(0);" >Publish</a>';

      }

      echo <<< EOT

      <td>{$review['posted_by']}</td>

      <td>{$rating}</td>

      <td class="small" style="width:50%"><h6>{$review['review']}</h6>{$review['description']}</td>

      <td>{$review['recieved_date']}</td>
