...
<h1 class="page-title"><i class="fa fa-calendar" style="color: #46be8a"></i> Your Upcoming Appointments List</h1>
...
<a href="#" onclick="history.go(-1)"><button class="btn btn-primary" type="button"><i class="fa fa-chevron-left" style="padding-right:8px"></i>BACK TO APPOINTMENTS LIST</button></a>
</div>
</div>
