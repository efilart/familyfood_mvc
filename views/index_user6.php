...
<title>User Panel - Appointment Confirmed | Familyfood Dashboard</title>
<!-- meta & scripts -->
<!-- Favicon -->
...
<tr>
<td>Day / Time</td>
<td>Thursday, Mar 17 at 12:00 PM (EST)</td>
</tr>
<tr>
...
<button type="button" id="print_button" class="btn btn-success" value="PRINT APPOINTMENT" onclick="document.title = 'FamilyFoodLLC, AppointmentSummary';window.print();"/><i class="fa fa-print"></i> PRINT APPOINTMENT</button>
</p>
</div>
</div>
<div class="col-md-3"></div>
