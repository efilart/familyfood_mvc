...
<?php
  ...
  if( !empty( $reviews ) ){
    ...
    $starRating = array(
      ...
      1 => '<i class="icon wb-star orange-600" data-alt="1" title="bad"></i><i class="icon wb-star" data-alt="2" title="poor"></i><i class="icon wb-star" data-alt="3" title="regular"></i><i class="icon wb-star" data-alt="4" title="good"></i><i class="icon wb-star" data-alt="5" title="amf"></i>',
