...
$.ajax({
                url: 'customerservicedetails' ,
				data: "username="+$("#userid").val()+"&password="+$("#pwd").val(),
				type :'POST',
                success: manageappointments,
                failure: manageappointments,
                dataType: 'text',
                cache: true
...
function manageappointments(data) {
if(data == "fail") {
$(".erromsg").css('display','block');
...
if(event.keyCode == 13) {
if((validateinputs()) && (customerservicedetails())) {
return true;
} else {
return false;
}
...
<header>
    ...
    <!-- START MAIN CONTENT -->
    	<div class="container content">
        	<div class="counselor">
            	<h2>Customer Service Login</h2><br>
  ...
  <div class="form-group ">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="button" onclick ="return (validateinputs() && customerservicedetails())"  id="loginbutton" class="btn btn-primary">Sign in</button>
    </div>
  </div>
</form>
