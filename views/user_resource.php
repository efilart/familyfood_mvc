...
<title>My Nutrition Resources | Food Demos</title>
<!-- meta & scripts -->
<!-- Favicon -->
...
<h1 class="page-title">My Nutrition Resources</h1>
<!--div class="page-header-actions"> <a href="#" role="button" class="btn btn-danger btn-block btn-round"><i class="icon wb-plus" aria-hidden="true"></i>eh?</a>
</div-->
</div>
...
<div class="col-md-8">
<div class="panel-heading padding-bottom-25">
<h3 class="blue-600"><i class="icon wb-video" aria-hidden="true"></i>Food Demos
<!--small>Secondary text</small-->
</h3></div>
<div class="row">
<div class="col-sm-6">
<h4 class="example-title">Chocolate Surprise Brownies</h4>
<div class="cover plyr">
<video preload="metadata" controls crossorigin width="100%" height="auto" controls controlsList="nodownload">
<source src="../assets/assets/videos/Chocolate-Surprise-Brownies.mp4#t=1" type="video/mp4">
</video>
</div>
</div>

<div class="col-sm-6">
<h4 class="example-title">Cauliflower Alfredo</h4>
<div class="cover plyr">
<video preload="metadata" controls crossorigin width="100%" height="auto" controls controlsList="nodownload">
<source src="../assets/assets/videos/Cauliflower-Alfredo.mp4#t=1" type="video/mp4">
</video>
</div>
</div>
</div>
...
<div class="col-sm-6">
<h4 class="example-title">Make a Green Smoothie Bowl</h4>
<div class="cover plyr">
<video preload="metadata" controls crossorigin width="100%" height="auto" controls controlsList="nodownload">
<source src="../assets/assets/videos/Green-Smoothie.mp4#t=1" type="video/mp4">
</video>
</div>
</div>
	
<div class="col-sm-6">
<h4 class="example-title">How to Make Avocado White Bean Wrap</h4>
<div class="cover plyr">
<a href="https://familyfoodllc.com/blog/family-food-membership-program/" target="_blank">
<div class="ribbon ribbon-bookmark ribbon-bottom ribbon-danger"><span class="ribbon-inner">Get Full Access Now!</span></div>
<video preload="metadata" controls crossorigin width="100%" height="auto" controls controlsList="nodownload" poster="../assets/assets/videos/cover_smoothie_bowl.jpg">
...
<div class="row padding-top-25">
<div class="col-sm-6">
<h4 class="example-title">How to Make Buffalo Chicken Chili</h4>
<div class="cover plyr">
<a href="https://familyfoodllc.com/blog/family-food-membership-program/" target="_blank">
<div class="ribbon ribbon-bookmark ribbon-bottom ribbon-danger"><span class="ribbon-inner">Get Full Access Now!</span></div>
<video preload="metadata" controls crossorigin width="100%" height="auto" controls controlsList="nodownload" poster="../assets/assets/videos/cover_buffalo_chicken.jpg">
<source src="#" type="video/mp4">
</video>
</a>
</div>
...
<div class="col-sm-6">
<h4 class="example-title">How to Make Chicken Fajitas</h4>
<div class="cover plyr">
<a href="https://familyfoodllc.com/blog/family-food-membership-program/" target="_blank">
<div class="ribbon ribbon-bookmark ribbon-bottom ribbon-danger"><span class="ribbon-inner">Get Full Access Now!</span></div>
<video preload="metadata" controls crossorigin width="100%" height="auto" controls controlsList="nodownload" poster="../assets/assets/videos/cover_chicken_fajitas.jpg">
<source src="#" type="video/mp4">
</video>
</a>
</div>
...
<div class="row padding-top-25">
<div class="col-sm-6">
<h4 class="example-title">How to Make Greek Yogurt Fruit Tart</h4>
<div class="cover plyr">
<a href="https://familyfoodllc.com/blog/family-food-membership-program/" target="_blank">
<div class="ribbon ribbon-bookmark ribbon-bottom ribbon-danger"><span class="ribbon-inner">Get Full Access Now!</span></div>
<video preload="metadata" controls crossorigin width="100%" height="auto" controls controlsList="nodownload" poster="../assets/assets/videos/cover_fruit_tart.jpg">
<source src="#" type="video/mp4">
</video>
</a>
</div>
...
<div class="col-sm-6">
<h4 class="example-title">How to Make Breakfast Bars</h4>
<div class="cover plyr">
<a href="https://familyfoodllc.com/blog/family-food-membership-program/" target="_blank">
<div class="ribbon ribbon-bookmark ribbon-bottom ribbon-danger"><span class="ribbon-inner">Get Full Access Now!</span></div>
<video preload="metadata" controls crossorigin width="100%" height="auto" controls controlsList="nodownload" poster="../assets/assets/videos/cover_breakfast_bars.jpg">
<source src="#" type="video/mp4">
</video>
</a>
</div>
...
<div class="col-md-4"><?php include("inc_user_access.php"); ?></div>
