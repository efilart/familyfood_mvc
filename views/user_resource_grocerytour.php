...
<title>My Nutrition Resources | Virtual Grocery Store Tour</title>
<!-- meta & scripts -->
<!-- Favicon -->
...
<h3 class="blue-600"><i class="icon wb-video" aria-hidden="true"></i>Virtual Grocery Store Tour
<!--small>Secondary text</small-->
</h3></div>
<div class="row">
<div class="col-sm-6">
<h4 class="example-title">Grocery Shopping Tips 1: Produce</h4>
<div class="cover plyr">
<video preload="metadata" controls crossorigin width="100%" height="auto" controls controlsList="nodownload">
<source src="../assets/assets/videos/Grocery_Shopping_Tips_1_Produce.mp4#t=5" type="video/mp4">
</video>
</div>
</div>

<div class="col-sm-6">
<h4 class="example-title">Grocery Shopping Tips 2: Grains</h4>
<div class="cover plyr">
<video preload="metadata" controls crossorigin width="100%" height="auto" controls controlsList="nodownload">
<source src="../assets/assets/videos/Grocery_Shopping_Tips_2_Grains.mp4#t=3" type="video/mp4">
</video>
</div>
</div>
</div>
...
<div class="col-sm-6">
<h4 class="example-title">Grocery Shopping Tips 3: Bars and Snacks</h4>
<div class="cover plyr">
<video preload="metadata" controls crossorigin width="100%" height="auto" controls controlsList="nodownload">
<source src="../assets/assets/videos/Grocery_Shopping_Tips_3__Bars_and_Snacks.mp4#t=1" type="video/mp4">
</video>
</div>
</div>
	
<div class="col-sm-6">
<h4 class="example-title">Grocery Shopping Tips 4: Dairy</h4>
<div class="cover plyr">
...
<video preload="metadata" controls crossorigin width="100%" height="auto" controls controlsList="nodownload" poster="../assets/assets/videos/cover_tour_dairy.jpg">
...
<div class="row padding-top-25">
<div class="col-sm-6">
<h4 class="example-title">Grocery Shopping Tips 5 - Meat and Poultry</h4>
<div class="cover plyr">
<a href="https://familyfoodllc.com/blog/family-food-membership-program/" target="_blank">
<div class="ribbon ribbon-bookmark ribbon-bottom ribbon-danger"><span class="ribbon-inner">Get Full Access Now!</span></div>
<video preload="metadata" controls crossorigin width="100%" height="auto" controls controlsList="nodownload" poster="../assets/assets/videos/cover_tour_meat_poultry.jpg">
<source src="#" type="video/mp4">
</video>
</a>
</div>
...
<div class="col-sm-6">
<h4 class="example-title">Grocery Shopping Tips 6 - Fish and Seafood</h4>
<div class="cover plyr">
<a href="https://familyfoodllc.com/blog/family-food-membership-program/" target="_blank">
<div class="ribbon ribbon-bookmark ribbon-bottom ribbon-danger"><span class="ribbon-inner">Get Full Access Now!</span></div>
<video preload="metadata" controls crossorigin width="100%" height="auto" controls controlsList="nodownload" poster="../assets/assets/videos/cover_tour_fish.jpg">
<source src="#" type="video/mp4">
</video>
</a>
</div>
...
<div class="row padding-top-25">
<div class="col-sm-6">
<h4 class="example-title">Grocery Shopping Tips 7 - Canned Goods</h4>
<div class="cover plyr">
<a href="https://familyfoodllc.com/blog/family-food-membership-program/" target="_blank">
<div class="ribbon ribbon-bookmark ribbon-bottom ribbon-danger"><span class="ribbon-inner">Get Full Access Now!</span></div>
<video preload="metadata" controls crossorigin width="100%" height="auto" controls controlsList="nodownload" poster="../assets/assets/videos/cover_tour_meat_poultry.jpg">
...
<div class="col-sm-6">
<h4 class="example-title">Grocery Shopping Tips 8 - Frozen Aisle</h4>
<div class="cover plyr">
<a href="https://familyfoodllc.com/blog/family-food-membership-program/" target="_blank">
<div class="ribbon ribbon-bookmark ribbon-bottom ribbon-danger"><span class="ribbon-inner">Get Full Access Now!</span></div>
<video preload="metadata" controls crossorigin width="100%" height="auto" controls controlsList="nodownload" poster="../assets/assets/videos/cover_tour_frozen_aisle.jpg">
<source src="#" type="video/mp4">
</video>
</a>
</div>
