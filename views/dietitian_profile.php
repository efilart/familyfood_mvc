...
<h1 class="page-title">Edit Dietitian Profile</h1>
</div>
<div class="panel">
...
<input type="password" class="form-control" id="inputAddress" name="inputAddress" placeholder="Address" autocomplete="off" />
</div>
<div class="form-group">
