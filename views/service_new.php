...
<title>New Appointment | Family Food Service Dashboard</title>
...
<h1 class="page-title">New Appontment</h1>

<div class="page-header-actions"><a href="#" role="button" class="btn btn-danger btn-block btn-round"><i class="icon wb-plus" aria-hidden="true"></i>Manage Appointments</a>
