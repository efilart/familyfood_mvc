...
$generate = '';
  if( empty( $content ) ){
			$generate = '<a href="viewReport?content=1&sn_uid='.$sn_uid.'&sn_date_created='.$sn_date_created.'"><i class="fa fa-file-pdf-o my-float"></i></a>';
...
$date_format = date_format( date_create( $sn_date_created ),'F d, Y');
$pear = 'No';
$apple = 'No';
...
$diet_name = "";
if( property_exists($diet_details, "first_name" ) ){
    $diet_name .= $diet_details->first_name." ";
}
if( property_exists($diet_details, "last_name" ) ){
    $diet_name .= $diet_details->last_name;
}
$html = <<< EOT
<!doctype html>
<html>
...
<title>Session Flow - Nutrition Assessment for {$user_full_name} - {$date_format}</title>
<style>
.demo {
...
<a href="#" class="float" id="menu-share"><i class="fa fa-cogs fa-lg my-float"></i></a>
<ul>
<li><a href="#top"><i class="fa fa-arrow-up my-float"></i></a></li>
<li><a href="javascript:window.print()"><i class="fa fa-print my-float"></i></a></li>
<li>{$generate}</li>
</ul>
<a name="top"></a>
<div id="test">
<h1 style="color: green">{$user_full_name} - {$date_format} / Nutrition Assessment</h1>
<h2 style="color: green">Prepared by: RDN {$diet_name}</h2>
...
<table class="demo">
  <thead>
  <tr>
    <th colspan="2">I’m going to read you several statements that people have made about their food situation. For these statements, please tell me whether the statement was often true, sometimes true, or never true for (you/your household) in the last 12 months—that is, since last (name of current month).
    </th>
  <tr>
    <th>The first statement is, “The food that (I/we) bought just didn’t last, and (I/we) didn’t have money to get more.” Was that often, sometimes, or never true for (you/your household) in the last 12 months? </th>
    <th>“(I/we) couldn’t afford to eat balanced meals.” Was that often, sometimes, or never true for (you/your household) in the last 12 months? </th>
  </tr>
  </thead>
  <tbody>
  <tr>
    <td>{$session_note_details['sn_quest22']}</td>
    <td>{$session_note_details['sn_quest23']}</td>
  </tr>
  </tbody>
</table>
<table class="demo">
...
<table class="demo">
  ...
  <tr>
    <td>{$pear}</td>
    <td>{$apple}</td>
    <td>{$dietAdvice['da_waist']}</td>
    <td>{$dietAdvice['da_neck']}</td>
  </tr>
  </tbody>
</table>
<br /><br /><br />
...
<table class="demo">
  <thead>
  <tr><th>Plan for next session</th></tr>
  </thead>
  <tbody>
  <tr><td>{$dietAdvice['da_q6']}</td></tr>
  </tbody>
</table>
<a name="p2"></a>
<!-- diagnosis -->
<h1 style="color: green">{$user_full_name} - {$date_format} / Diagnosis</h1>
...
<thead>
  ...
  <tr>
    <td>
<p {$ID_1_1}>Increased energy expenditure NI-1.1 10633</p>
<p {$ID_1_2}>Inadequate energy intake NI-1.2 10634</p>
<p {$ID_1_3}>Excessive energy intake NI-1.3 10635</p>
<p {$ID_1_4}>Predicted inadequate energy intake NI-1.4 10636</p>
<p {$ID_1_5}>Predicted excessive energy intake NI-1.5 10637</p>
<hr />
<h4>Etiologies:</h4>
<p>{$bundle1_1}</p>
...
<p>{$bundle1_3}</p>
    ...
    <td>
<p {$ID_2_1}>Inadequate oral intake NI-2.1 10639</p>
<p {$ID_2_2}>Excessive oral intake NI-2.2 10640</p>
<p {$ID_2_3}>Inadequate enteral nutrition infusion NI-2.3 10641</p>
<p {$ID_2_4}>Excessive enteral nutrition infusion NI-2.4 10642</p>
<p {$ID_2_5}>Enteral nutrition composition inconsistent with needs NI-2.5 11142</p>
<p {$ID_2_6}>Enteral nutrition administration inconsistent with needs NI-2.6 11143</p>
<p {$ID_2_7}>Inadequate parenteral nutrition infusion NI-2.7 10644</p>
<p {$ID_2_8}>Excessive parenteral nutrition infusion NI-2.8 10645</p>
<p {$ID_2_9}>Parenteral nutrition composition inconsistent with needs NI-2.9 11144</p>
<p {$ID_2_10}>Parenteral nutrition administration inconsistent with needs NI-2.10 11145</p>
<p {$ID_2_11}>Limited food acceptance NI-2.11 10647</p>
<hr />
<h4>Etiologies:</h4>
<p>{$bundle2_1}</p>
<h4>Signs / Symptoms:&nbsp;</h4>
...
<p>{$bundle2_3}</p>
    ...
    <td>
<p {$ID_3_1}>Inadequate fluid intake NI-3.1 10649</p>
<p {$ID_3_2}>Excessive fluid intake NI-3.2 10650</p>
<hr />
<h4>Etiologies:</h4>
<p>L{$bundle3_1}</p>
<h4>Signs / Symptoms:&nbsp;</h4>
...
<p {$ID_4_1_1}>Inadequate plant stanol ester intake NI-4.1.1 11077</p>
<p {$ID_4_1_2}>Inadequate plant sterol ester intake NI-4.1.2 11078</p>
<p {$ID_4_1_3}>Inadequate soy protein intake NI-4.1.3 11080</p>
<p {$ID_4_1_4}>Inadequate psyllium intake NI-4.1.4 11079</p>
<p {$ID_4_1_5}>Inadequate β-glucan intake NI-4.1.5 11076</p>
<hr>
<p class="h3">Excessive bioactive substance intake</p>
<p {$ID_4_2_1}>Excessive plant stanol ester intake NI-4.2.1 11084</p>
<p {$ID_4_2_2}>Excessive plant sterol ester intake NI-4.2.2 11085</p>
<p {$ID_4_2_3}>Excessive soy protein intake NI-4.2.3 11087</p>
<p {$ID_4_2_4}>Excessive psyllium intake NI-4.2.4 11086</p>
<p {$ID_4_2_5}>Excessive β-glucan intake NI-4.2.5 11081</p>
<p {$ID_4_2_6}>Excessive food additive intake NI-4.2.6 11083</p>
<p {$ID_4_2_7}>Excessive caffeine intake NI-4.2.7 11082</p>
<p {$ID_4_3}>Excessive alcohol intake NI-4.3 10654</p>
<hr />
<h4>Etiologies:</h4>
<p>{$bundle4_1}</p>
<h4>Signs / Symptoms:&nbsp;</h4>
...
<p>{$bundle4_3}</p>
    ...
    <td>
<p {$ID_5_1}>Increased nutrient needs NI-5.1 10656</p>
<p {$ID_5_2}>Inadequate protein-energy intake NI-5.2 10658</p>
<p {$ID_5_3}>Decreased nutrient needs NI-5.3 10659</p>
<p {$ID_5_4}>Imbalance of nutrients NI-5.4 10660</p>
<hr />
<h4>Specify:</h4>
<p>{$bundle5_1}</p>
<h4>Etiologies:</h4>
...
<p>{$bundle5_4}</p>
    ...
    <td>
<p {$ID_5_5_1}>Inadequate fat intake NI-5.5.1 10662</p>
<p {$ID_5_5_2}>Inadequate protein-energy intake NI-5.5.2 10658</p>
<p {$ID_5_5_3}>Intake of types of fats inconsistent with needs NI-5.5.3 10854</p>
<hr />
<h4>Specify:</h4>
<p>{$bundle6_1}</p>
<h4>Etiologies:</h4>
...
<thead>
  ...
  <tr>
    <td>
<p {$ID_5_6_1}>Inadequate protein intake NI-5.6.1 10666</p>
<p {$ID_5_6_2}>Excessive protein intake NI-5.6.2 10667</p>
<p {$ID_5_6_3}>Intake of types of proteins inconsistent with needs NI-5.6.3 10855</p>
<hr />
<h4>Specify:</h4>
<p>{$bundle7_1}</p>
<h4>Etiologies:</h4>
...
<p>{$bundle7_4}</p>
    ...
    <td>
<p {$ID_5_7_1}>Intake of types of amino acids inconsistent with needs NI-5.7.1 12007</p>
<hr />
<h4>Specify:</h4>
<p>{$bundle8_1}</p>
<h4>Etiologies:</h4>
...
<p>{$bundle8_4}</p>
    ...
    <td>
<p {$ID_5_8_1}>Inadequate carbohydrate intake NI-5.8.1 10670</p>
<p {$ID_5_8_2}>Excessive carbohydrate intake NI-5.8.2 10671</p>
<p {$ID_5_8_3}>Intake of types of carbohydrate inconsistent with needs NI-5.8.3 10856</p>
<p {$ID_5_8_4}>Inconsistent carbohydrate intake NI-5.8.4 10673</p>
<p {$ID_5_8_5}>Inadequate fiber intake NI-5.8.5 10675</p>
<p {$ID_5_8_6}>Excessive fiber intake NI-5.8.6 10676</p>
<hr />
<h4>Specify:</h4>
<p>{$bundle9_1}</p>
<h4>Etiologies:</h4>
...
<thead>
  ...
  <tr>
    <td>
    <h3 {$ID_5_9_1}>Inadequate vitamin intake (specify) NI-5.9.1 10678</h3>
<p {$ID_5_9_1_1}>A (1) 10679</p>
<p {$ID_5_9_1_2}>C (2) 10680</p>
<p {$ID_5_9_1_3}>D (3) 10681</p>
<p {$ID_5_9_1_4}>E (4) 10682</p>
<p {$ID_5_9_1_5}>K (5) 10683</p>
<p {$ID_5_9_1_6}>Thiamin (6) 10684</p>
<p {$ID_5_9_1_7}>Riboflavin (7) 10685</p>
<p {$ID_5_9_1_8}>Niacin (8) 10686</p>
<p {$ID_5_9_1_9}>Folate (9) 10687</p>
<p {$ID_5_9_1_10}>B6 (10) 10688</p>
<p {$ID_5_9_1_11}>B12 (11) 10689</p>
<p {$ID_5_9_1_12}>Pantothenic acid (12) 10690</p>
<p {$ID_5_9_1_13}>Biotin (13) 10691</p>
<h3 {$ID_5_9_2}>Excessive vitamin intake (specify) NI-5.9.2 10693</h3>
<p {$ID_5_9_2_2}>A (1) 10694</p>
<p {$ID_5_9_2_3}>C (2) 10695</p>
<p {$ID_5_9_2_4}>D (3) 10696</p>
<p {$ID_5_9_2_5}>E (4) 10697</p>
<p {$ID_5_9_2_6}>K (5) 10698</p>
<p {$ID_5_9_2_7}>Thiamin (6) 10699</p>
<p {$ID_5_9_2_8}>Riboflavin (7) 10700</p>
<p {$ID_5_9_2_9}>Niacin (8) 10701</p>
<p {$ID_5_9_2_10}>Folate (9) 10702</p>
<p {$ID_5_9_2_11}>B6 (10) 10703</p>
<p {$ID_5_9_2_12}>B12 (11) 10704</p>
<p {$ID_5_9_2_13}>Pantothenic acid (12) 10705</p>
<p {$ID_5_9_2_14}>Biotin (13) 10706</p>
<!--hr />
<h4>Specify:</h4>
<p>{$bundle10_1}</p>
<h4>Etiologies:</h4>
...
<p>{$bundle10_4}</p-->
    ...
    <td>
<h3 {$ID_5_10_1}>Inadequate mineral intake (specify) NI-5.10.1 10709</h3>
<p {$ID_5_10_1_1}>Calcium (1) 10710</p>
<p {$ID_5_10_1_2}>Chloride (2) 10711</p>
<p {$ID_5_10_1_3}>Iron (3) 10712</p>
<p {$ID_5_10_1_4}>Magnesium (4) 10713</p>
<p {$ID_5_10_1_5}>Potassium (5) 10714</p>
<p {$ID_5_10_1_6}>Phosphorus (6) 10715</p>
<p {$ID_5_10_1_7}>Sodium (7) 10716</p>
<p {$ID_5_10_1_8}>Zinc (8) 10717</p>
<p {$ID_5_10_1_9}>Sulfate (9) 10718</p>
<p {$ID_5_10_1_10}>Fluoride (10) 10719</p>
<p {$ID_5_10_1_11}>Copper (11) 10720</p>
<p {$ID_5_10_1_12}>Iodine (12) 10721</p>
<p {$ID_5_10_1_13}>Selenium (13) 10722</p>
<p {$ID_5_10_1_14}>Manganese (14) 10723</p>
<p {$ID_5_10_1_15}>Chromium (15) 10724</p>
<p {$ID_5_10_1_16}>Molybdenum (16) 10725</p>
<p {$ID_5_10_1_17}>Boron (17) 10726</p>
<p {$ID_5_10_1_18}>Cobalt (18) 10727</p>
<h3 {$ID_5_10_2}>Excessive mineral intake (specify) NI-5.10.2 10729</h3>
<p {$ID_5_10_2_1}>Calcium (1) 10730</p>
<p {$ID_5_10_2_2}>Chloride (2) 10731</p>
<p {$ID_5_10_2_3}>Iron (3) 10732</p>
<p {$ID_5_10_2_4}>Magnesium (4) 10733</p>
<p {$ID_5_10_2_5}>Potassium (5) 10734</p>
<p {$ID_5_10_2_6}>Phosphorus (6) 10735</p>
<p {$ID_5_10_2_7}>Sodium (7) 10736</p>
<p {$ID_5_10_2_8}>Zinc (8) 10737</p>
<p {$ID_5_10_2_9}>Sulfate (9) 10738</p>
<p {$ID_5_10_2_10}>Fluoride (10) 10739</p>
<p {$ID_5_10_2_11}>Copper (11) 10740</p>
<p {$ID_5_10_2_12}>Iodine (12) 10741</p>
<p {$ID_5_10_2_13}>Selenium (13) 10742</p>
<p {$ID_5_10_2_14}>Manganese (14) 10743</p>
<p {$ID_5_10_2_15}>Chromium (15) 10744</p>
<p {$ID_5_10_2_16}>Molybdenum (16) 10745</p>
<p {$ID_5_10_2_17}>Boron (17) 10746</p>
<p {$ID_5_10_2_18}>Cobalt (18) 10747</p>
<!--hr />
<h4>Specify:</h4>
<p>{$bundle11_1}</p>
<h4>Etiologies:</h4>
...
<p>{$bundle11_4}</p>
    ...
    <td>
<p {$ID_5_11_1}>Predicted inadequate nutrient intake NI-5.11.1 10750</p>
<h4>Specify:</h4>
<p>Lorem ipsum dolor.</p>
<hr />
<p {$ID_5_11_2}>Predicted excessive nutrient intake NI-5.11.2 10751</p>
<h4>Specify:</h4>
<p>{$bundle12_1}</p>
<!--h4>Etiologies:</h4>
<p>{$bundle12_2}</p>
...
<p {$ID_NC_1_1}>Swallowing difficulty NC-1.1 10754</p>
<p {$ID_NC_1_2}>Biting/Chewing (masticatory) difficulty NC-1.2 10755</p>
<p {$ID_NC_1_3}>Breastfeeding difficulty NC-1.3 10756</p>
<p {$ID_NC_1_4}>Altered GI function NC-1.4 10757</p>
<p {$ID_NC_1_5}>Predicted breastfeeding difficulty NC-1.5 11146</p>
<hr />
<h4>Etiologies:</h4>
<p>{$bundle13_1}</p>
<h4>Signs / Symptoms:&nbsp;</h4>
...
<p {$ID_NC_2_1}>Impaired nutrient utilization NC-2.1 10759</p>
<p {$ID_NC_2_2}>Altered nutrition-related laboratory values NC-2.2 10760</p>
<p {$ID_NC_2_3}>Food–medication interaction NC-2.3 10761</p>
<p {$ID_NC_2_4}>Predicted food–medication interaction NC-2.4 10762</p>
<h4>Specify:</h4>
<p>{$bundle14_1}</p>
<h4>Etiologies:</h4>
<p>{$bundle14_2}</p>
...
<p {$ID_NC_3_1}>Underweight NC-3.1 10764</p>
<p {$ID_NC_3_2}>Unintended weight loss NC-3.2 10765</p>
<h3 {$ID_NC_3_3}>Overweight/obesity NC-3.3 10766</h3>
<p {$ID_NC_3_3_1}>Overweight, adult or pediatric NC-3.3.1 10767</p>
<p {$ID_NC_3_3_2}>Obese, pediatric NC-3.3.2 10768</p>
<p {$ID_NC_3_3_3}>Obese, Class I NC-3.3.3 10769</p>
<p {$ID_NC_3_3_4}>Obese, Class II NC-3.3.4 10818</p>
<p {$ID_NC_3_3_5}>Obese, Class III NC-3.3.5 10819</p>
<p {$ID_NC_3_4}>Unintended weight gain NC-3.4 10770</p>
<p {$ID_NC_3_5}>Growth rate below expected NC-3.5 10802</p>
<p {$ID_NC_3_6}>Excessive growth rate NC-3.6 10803</p>
<h4>Etiologies:</h4>
<p>{$bundle15_1}</p>
<h4>Signs / Symptoms:&nbsp;</h4>
  <p>{$bundle15_2}</p> 
...
<thead>
  ...
  <tr>
    <td>
<h3 {$ID_NC_4_1}>Malnutrition NC-4.1 10657</h3>
<p {$ID_NC_4_1_1}>Starvation related malnutrition NC-4.1.1 11130</p>
<p {$ID_NC_4_1_2}>Chronic disease or condition related malnutrition NC-4.1.2 11131</p>
<p {$ID_NC_4_1_3}>Acute disease or injury related malnutrition NC-4.1.3 11132</p>
<h4>Etiologies:</h4>
<p>{$bundle16_1}</p>
<h4>Signs / Symptoms:&nbsp;</h4>
<p>{$bundle16_2}</p> 
...
<tr>
<td>
<p {$ID_NB_1_1}>Food- and nutrition-related knowledge deficit NB-1.1 10773</p>
<p {$ID_NB_1_2}>Unsupported beliefs/attitudes about food- or nutrition-related topics (use with caution) NB-1.2 10857</p>
<p {$ID_NB_1_3}>Not ready for diet/lifestyle change NB-1.3 10775</p>
<p {$ID_NB_1_4}>Self-monitoring deficit NB-1.4 10776</p>
<p {$ID_NB_1_5}>Disordered eating pattern NB-1.5 10777</p>
<p {$ID_NB_1_6}>Limited adherence to nutrition-related recommendations NB-1.6 10778</p>
<p {$ID_NB_1_7}>Undesirable food choices NB-1.7 10779</p>
<hr>
<h4>Etiologies:</h4>
<p>{$bundle17_1}</p>
<h4>Signs/Symptoms:</h4>
...
<td>
<p {$ID_NB_2_1}>Physical inactivity NB-2.1 10782</p>
<p {$ID_NB_2_2}>Excessive physical activity NB-2.2 10783</p>
<p {$ID_NB_2_3}>Inability to manage self-care NB-2.3 10780</p>
<p {$ID_NB_2_4}>Impaired ability to prepare foods/meals NB-2.4 10785</p>
<p {$ID_NB_2_5}>Poor nutrition quality of life NB-2.5 10786</p>
<p {$ID_NB_2_6}>Self-feeding difficulty NB-2.6 10787</p>
<hr>
<h4>Etiologies:</h4>
<p>{$bundle18_1}</p>
<h4>Signs/Symptoms:</h4>
...
<td>
<p {$ID_NB_3_1}>Intake of unsafe food NB-3.1 10789</p>
<p {$ID_NB_3_2}>Limited access to food NB-3.2 12009</p>
<p {$ID_NB_3_3}>Limited access to nutrition-related supplies NB-3.3 10791</p>
<p {$ID_NB_3_4}>Limited access to potable water NB-3.4 12010</p>
<hr>
<h4>Etiologies:</h4>
<p>{$bundle19_1}</p>
<h4>Signs/Symptoms:</h4>
<p>{$bundle19_2}</p>
<h4>Diagnosi9 Status:</h4>
<p>{$bundle19_3}</p>
</td>
</tr>
</thead>
...
<tr>
<td>
<p {$ID_NO_1_1}>No nutrition diagnosis at this time NO-1.1 10795</p>
<hr>
<h4>Etiologies:</h4>
<p>{$bundle20_1}</p>
<h4>Signs/Symptoms:</h4>
...
<table class="demo">
<thead>
  <tr><th colspan="3"><h1 style="color: green">{$user_full_name} - {$date_format} / Intervention</h1><br />
...
<thead>
  ...
  <tr>
    <td>
<p {$IDENTIFIER_E1_1}>Purpose of the nutrition education E-1.1 10588</p>
<p {$IDENTIFIER_E1_2}>Priority modifications E-1.2 10589</p>
<p {$IDENTIFIER_E1_3}>Survival information E-1.3 10590</p>
<p {$IDENTIFIER_E1_4}>Nutrition relationship to health/disease E-1.4 10591</p>
<p {$IDENTIFIER_E1_5}>Recommended modifications E-1.5 10592</p>
<p {$IDENTIFIER_E1_6}>Other or related topics E-1.6 10593</p>
<p {$IDENTIFIER_E1_7}>Other E-1.7 10594</p>
<p {$IDENTIFIER_E1_8}>Physical activity guidance E-1.8 12012</p>

<h4>Details:</h4>
<p>{$sn3_t7}</p>
    </td>
    <td>
<p {$IDENTIFIER_E2_1}>Result interpretation E-2.1 10596</p>
<p {$IDENTIFIER_E2_2}>Skill development E-2.2 10597</p>
<p {$IDENTIFIER_E2_3}>Other E-2.3 10598</p>
<h4>Details:</h4>
<p>{$sn3_t8}</p>
    </td>
  </tr>
...
<thead>
  ...
  <tr>
    <td>
<p {$IDENTIFIER_C1_1}>Cognitive-behavioral theory C-1.1 10601</p>
<p {$IDENTIFIER_C1_2}>Health belief model C-1.2 10602</p>
<p {$IDENTIFIER_C1_3}>Social learning theory C-1.3 10603</p>
<p {$IDENTIFIER_C1_4}>Transtheoretical model/stages of change C-1.4 10604</p>
<p {$IDENTIFIER_C1_5}>Other C-1.5 10605</p>

<h4>Details:</h4>
<p>{$sn3_t9}</p>
    </td>
    <td>
<p {$IDENTIFIER_C2_1}>Motivational interviewing C-2.1 10607</p>
<p {$IDENTIFIER_C2_2}>Goal setting C-2.2 10608</p>
<p {$IDENTIFIER_C2_3}>Self-monitoring C-2.3 10609</p>
<p {$IDENTIFIER_C2_4}>Problem solving C-2.4 10610</p>
<p {$IDENTIFIER_C2_5}>Social support C-2.5 10611</p>
<p {$IDENTIFIER_C2_6}>Stress management C-2.6 10612</p>
<p {$IDENTIFIER_C2_7}>Stimulus control C-2.7 10613</p>
<p {$IDENTIFIER_C2_8}>Cognitive restructuring C-2.8 10614</p>
<p {$IDENTIFIER_C2_9}>Relapse prevention C-2.9 10615</p>
<p {$IDENTIFIER_C2_10}>Rewards/contingency management C-2.10 10616</p>
<p {$IDENTIFIER_C2_11}>Other C-2.11 10617</p>
<h4>Specify:</h4>
<p>{$sn3_t10}</p>
    </td>
  </tr>
...
<thead>
  ...
  <tr>
    <td>
<p {$IDENTIFIER_RC1_1}>Team meeting RC-1.1 10620</p>
<p {$IDENTIFIER_RC1_2}>Referral to RDN with different expertise RC-1.2 10621</p>
<p {$IDENTIFIER_RC1_3}>Collaboration with other nutrition professionals RC-1.3 10622</p>
<p {$IDENTIFIER_RC1_4}>Collaboration with other providers RC-1.4 10812</p>
<p {$IDENTIFIER_RC1_5}>Referral to other providers RC-1.5 10624</p>
<p {$IDENTIFIER_RC1_6}>Referral to community agencies/programs RC-1.6 10625</p>
<hr />
<h4>Details:</h4>
<p>{$sn3_t11}</p>
    </td>
    <td>
<p {$IDENTIFIER_RC2_1}>Discharge and transfer to other providers RC-2.1 10813</p>
<p {$IDENTIFIER_RC2_2}>Discharge and transfer to community agencies/programs RC-2.2 10814</p>
<p {$IDENTIFIER_RC2_3}>Discharge and transfer to another nutrition professional RC-2.3 10627</p>
