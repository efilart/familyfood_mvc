...
<title>MyImpact - View Appointments | Familyfood Dashboard</title>
...
if( !empty( $impact_details ) ){
	...
	foreach( $impact_details as $details ){
		...
		$rd_impact_list .= "<td>".$status."</td>";

		$rd_impact_list .= "<td>".$by."</td>";
...
<div class="page-header-actions"> <a href="javascript:void(0);" onclick="showInsertModal()" role="button" class="btn btn-primary btn-block btn-round"><i class="icon wb-plus" aria-hidden="true"></i>ADD IMPACT</a> </div>
